const simulate1 = (switchDoor) => {
  ...
  //If you select the door with prize you only win if you choose to not switch door
  if (guess === doorWithPrize) {
    return !switchDoor;
  }

  //If you select a door without prize you only win if you choose to switch door
  return switchDoor;
}
